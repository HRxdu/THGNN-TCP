...
from dgl.dataloading.negative_sampler import GlobalUniform,Uniform
...
class LLMDataset(Dataset):
    def __init__(self, graph_path, args):
        ...
        self.neg_sampler = Uniform(k=1)

    def __getitem__(self, idx):
        pos_pairs = self.target_graph.edges('uv')
        neg_pairs = self.neg_sampler(self.target_graph, eids=self.target_graph.edges('eid'))
