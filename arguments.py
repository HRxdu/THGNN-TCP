...
parser.add_argument('--graph_path', type=str, default="./result/大模型/thg.dgl", help='网络保存地址(绝对路径)')
# parser.add_argument('--graph_path', type=str, default="D:/Hu/技术机会预测/result/大模型/thg1.dgl", help='网络保存地址(绝对路径)')
parser.add_argument('--graphs_path', type=str, default="./result/大模型/target_graphs.dgl", help='网络snapshots保存地址(绝对路径)')
...
parser.add_argument('--metapath_path', type=str, default="./result/大模型/temporal_metapath_dict_paper1.pkl", help='metapath字典保存地址(绝对路径)')
...
parser.add_argument('--metapath_masks', type=list, default=[1,1,1], help='元路径掩膜')
parser.add_argument('--feature_masks', type=list, default=[1,1,1], help='特征掩膜')
